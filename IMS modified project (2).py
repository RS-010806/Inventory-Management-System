...
# NUMPY
'''universal standard for working with numerical data in Python. Array- containers which are able to store more
...
#STRING
'''This module will help you quickly access some string constants
...
def check_out():
    ...
    order_id = np.random.randint(10**5, 10**6) #Generates an array
...
def sql_connectivity_backup():
    ...
    object = sql.connect(host = 'localhost', user = 'root', password = 'rishi@2006')
